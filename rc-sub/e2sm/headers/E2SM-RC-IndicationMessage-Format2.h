...
/* Forward definitions */
typedef struct E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member {
	UEID_t	 ueID;
	struct E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member__ranP_List {
		A_SEQUENCE_OF(typedef struct E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member__ranP_List__Member {
		...
		} E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member__ranP_List__Member;
		E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member__ranP_List__Member) list;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member;
...
typedef struct E2SM_RC_IndicationMessage_Format2 {
	struct E2SM_RC_IndicationMessage_Format2__ueParameter_List {
		A_SEQUENCE_OF(E2SM_RC_IndicationMessage_Format2__ueParameter_List__Member) list;
