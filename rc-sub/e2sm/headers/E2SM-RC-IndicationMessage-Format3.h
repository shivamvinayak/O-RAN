...
/* Forward definitions */
typedef struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member {
	CGI_t	 cellGlobal_ID;
...
} E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member;
...
typedef struct E2SM_RC_IndicationMessage_Format3 {
	struct E2SM_RC_IndicationMessage_Format3__cellInfo_List {
		A_SEQUENCE_OF(E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member) list;
