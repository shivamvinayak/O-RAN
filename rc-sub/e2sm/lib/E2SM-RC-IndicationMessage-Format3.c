...
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member, cellGlobal_ID),
	...
	{ ATF_POINTER, 3, offsetof(struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member, cellContextInfo),
	...
	{ ATF_POINTER, 2, offsetof(struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member, cellDeleted),
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member, neighborRelation_Table),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member),
	offsetof(struct E2SM_RC_IndicationMessage_Format3__cellInfo_List__Member, _asn_ctx),
