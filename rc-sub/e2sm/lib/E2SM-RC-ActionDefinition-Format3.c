...
static asn_TYPE_member_t asn_MBR_Member_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_ActionDefinition_Format3__ranP_InsertIndication_List__Member, ranParameter_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_ActionDefinition_Format3__ranP_InsertIndication_List__Member, ranParameter_value),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_4 = {
	sizeof(struct E2SM_RC_ActionDefinition_Format3__ranP_InsertIndication_List__Member),
	offsetof(struct E2SM_RC_ActionDefinition_Format3__ranP_InsertIndication_List__Member, _asn_ctx),
