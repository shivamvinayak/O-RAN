...
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_ActionDefinition_Format2__ric_PolicyConditions_List__Member, ric_PolicyAction),
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_RC_ActionDefinition_Format2__ric_PolicyConditions_List__Member, ric_PolicyConditionDefinition),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct E2SM_RC_ActionDefinition_Format2__ric_PolicyConditions_List__Member),
	offsetof(struct E2SM_RC_ActionDefinition_Format2__ric_PolicyConditions_List__Member, _asn_ctx),
