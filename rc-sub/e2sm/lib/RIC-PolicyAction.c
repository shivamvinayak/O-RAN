...
static asn_TYPE_member_t asn_MBR_Member_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RIC_PolicyAction__ranParameters_List__Member, ranParameter_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RIC_PolicyAction__ranParameters_List__Member, ranParameter_valueType),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_4 = {
	sizeof(struct RIC_PolicyAction__ranParameters_List__Member),
	offsetof(struct RIC_PolicyAction__ranParameters_List__Member, _asn_ctx),
