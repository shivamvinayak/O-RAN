...
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_ControlOutcome_Format1__ranP_List__Member, ranParameter_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_ControlOutcome_Format1__ranP_List__Member, ranParameter_value),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct E2SM_RC_ControlOutcome_Format1__ranP_List__Member),
	offsetof(struct E2SM_RC_ControlOutcome_Format1__ranP_List__Member, _asn_ctx),
