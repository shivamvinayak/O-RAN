...
static asn_TYPE_member_t asn_MBR_ueType_3[] = {
	{ ATF_POINTER, 0, offsetof(struct EventTrigger_UE_Info_Item__ueType, choice.ueType_Choice_Indiviaul),
...
static const asn_TYPE_tag2member_t asn_MAP_ueType_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ueType-Choice-Indiviaul */
