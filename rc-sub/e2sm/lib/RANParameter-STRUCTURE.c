...
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANParameter_STRUCTURE__sequence_of_ranParameters__Member, ranParameter_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct RANParameter_STRUCTURE__sequence_of_ranParameters__Member, ranParameter_valueType),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct RANParameter_STRUCTURE__sequence_of_ranParameters__Member),
	offsetof(struct RANParameter_STRUCTURE__sequence_of_ranParameters__Member, _asn_ctx),
