...
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TriggerType_Choice_RRCstate__rrcState_List__Member, stateChangedTo),
	...
	{ ATF_POINTER, 1, offsetof(struct TriggerType_Choice_RRCstate__rrcState_List__Member, logicalOR),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct TriggerType_Choice_RRCstate__rrcState_List__Member),
	offsetof(struct TriggerType_Choice_RRCstate__rrcState_List__Member, _asn_ctx),
