...
static asn_oer_constraints_t asn_OER_type_cellInfo_List_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..65535)) */};
static asn_per_constraints_t asn_PER_type_cellInfo_List_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (SIZE(0..65535)) */,
	0, 0	/* No PER value map */
};
...
static asn_oer_constraints_t asn_OER_memb_cellInfo_List_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..65535)) */};
static asn_per_constraints_t asn_PER_memb_cellInfo_List_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (SIZE(0..65535)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Member_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage_Format4__ueInfo_List__Member, ueID),
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_RC_IndicationMessage_Format4__ueInfo_List__Member, ueContextInfo),
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_3 = {
	sizeof(struct E2SM_RC_IndicationMessage_Format4__ueInfo_List__Member),
	offsetof(struct E2SM_RC_IndicationMessage_Format4__ueInfo_List__Member, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_Member_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage_Format4__cellInfo_List__Member, cellGlobal_ID),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_CGI,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct E2SM_RC_IndicationMessage_Format4__cellInfo_List__Member, cellContextInfo),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_RC_IndicationMessage_Format4__cellInfo_List__Member, neighborRelation_Table),
...
static const int asn_MAP_Member_oms_8[] = { 1, 2 };
...
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_8 = {
	sizeof(struct E2SM_RC_IndicationMessage_Format4__cellInfo_List__Member),
	offsetof(struct E2SM_RC_IndicationMessage_Format4__cellInfo_List__Member, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_cellInfo_List_7[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_8,
...
static const ber_tlv_tag_t asn_DEF_cellInfo_List_tags_7[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_cellInfo_List_specs_7 = {
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_cellInfo_List_7 = {
	"cellInfo-List",
	"cellInfo-List",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_cellInfo_List_tags_7,
	sizeof(asn_DEF_cellInfo_List_tags_7)
		/sizeof(asn_DEF_cellInfo_List_tags_7[0]) - 1, /* 1 */
	asn_DEF_cellInfo_List_tags_7,	/* Same as above */
	sizeof(asn_DEF_cellInfo_List_tags_7)
		/sizeof(asn_DEF_cellInfo_List_tags_7[0]), /* 2 */
	{ &asn_OER_type_cellInfo_List_constr_7, &asn_PER_type_cellInfo_List_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_cellInfo_List_7,
	1,	/* Single element */
	&asn_SPC_cellInfo_List_specs_7	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_E2SM_RC_IndicationMessage_Format4_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2SM_RC_IndicationMessage_Format4, cellInfo_List),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_cellInfo_List_7,
		0,
		{ &asn_OER_memb_cellInfo_List_constr_7, &asn_PER_memb_cellInfo_List_constr_7,  memb_cellInfo_List_constraint_1 },
		0, 0, /* No default value */
		"cellInfo-List"
		},
};
